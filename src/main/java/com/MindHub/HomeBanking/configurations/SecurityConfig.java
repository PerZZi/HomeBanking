...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{//modificando las reglas de la seguridad de la app
        ...
        http.authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers("/api/clients/current","/web/**","/js/**","/api/accounts/*/transactions","/api/clients/current/accounts","/api/clients/current/cards","/api/loans").hasAuthority("CLIENT")
